...
export const failureInValidation =
  "Scenario validation failed. Please read the instructions carefully and try again";
export const deletedEnvironmentSuccessfully =
  "Deleted environment successfully";
export const generatingEnvironment = "Generating environment...";
export const validatingEnvironment =
  "Validating environment. This may take sometime...";
...
export const hideNavBarPath = ["/student-data"];
